...
spritePaths = {
    "kidicarus": "../data/sprites/kidicarus", 
    "loderunner": "../data/sprites/loderunner",
    "megaman": "../data/sprites/megaman",
    "supermariobros": "../data/sprites/supermariobros",
    "thelegendofzelda": "../data/sprites/thelegendofzelda",
}
